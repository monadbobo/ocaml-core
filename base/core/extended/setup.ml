...
(* OASIS_START *)
(* DO NOT EDIT (digest: b38adba96528a02ab0a8dd77aee987a6) *)
(*
...
let setup_t =
  {
     ...
     doc = [("core-extended", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("core-extended", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("test_runner",
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-Ilib"])];
                      ...
                      },
                   {
                      lib_modules =
                        [
                           ...
                           "Readline__list_zipper";
                           "Readline__string_zipper";
                      ...
                      lib_findlib_name = Some "core_extended";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "core_hello.ml"; });
               Executable
                 ({
                     cs_name = "core_extended_hello";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "core_extended"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "core_extended_hello.ml";
                      });
               Doc
                 ({
                     cs_name = "core-extended";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      doc_title = "Jane street's core extended library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                     ...
                     },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "core_hello";
                           InternalExecutable "core_extended_hello"
                        ];
                      });
               Executable
                 ({
