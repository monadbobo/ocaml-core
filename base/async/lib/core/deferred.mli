...
(** Set this to [true] to trigger debug print statements when [connect] is called
    for the tail-call optimization in bind. This was used to verify coverage in
    the Bind_test test-suite. *)
