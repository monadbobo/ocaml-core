...
(** [syscall t f] runs [Async_core.syscall] with [f] on the file descriptor underlying
...
(** [replace t kind] is for internal use only, by Async_unix.  It is used when one wants
